...
## Fork of stm8flash
For this project, I [forked stm8flash](https://github.com/thatoddmailbox/stm8flash to allow selecting an ST-LINK adapter based on its port number. This was done as part of the serial number matching code. For example, to select the adapter on port 1, set the serial number `port:1`.