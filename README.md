...
There is also some generic stm8 code in the `stm8/` folder, to set up and use various peripherals. There's also some shared definitions in the `shared/` folder, which is used for the communication protocol between the base and keypad.
